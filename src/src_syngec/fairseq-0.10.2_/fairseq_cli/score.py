...
import logging
logging.basicConfig(filename='/opt/data/private/zjx/SynGEC-main/glat_syntax_raw_deen_log.log',  # syntax_
    ...
    if args.sacrebleu:
        ...
        def score(fdsys):
            with open(args.ref) as fdref:
                ...
                logging.info(sacrebleu.corpus_bleu(fdsys, [fdref]))
        ...
        def score(fdsys):
            with open(args.ref) as fdref:
                ...
                for i, (sys_tok, ref_tok) in enumerate(
                    ...
                    logging.info("%s %s", i, scorer.result_string(args.order))
        ...
        def score(fdsys):
            with open(args.ref) as fdref:
                ...
                logging.info(scorer.result_string(args.order))
