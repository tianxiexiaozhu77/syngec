...
class NATransformerDecoder(FairseqNATDecoder):
    ...
    def forward_length(self, normalize, encoder_out):
        ...
        enc_feats = encoder_out.encoder_out                             # encoder_out["encoder_out"][0]
        # if len(encoder_out["encoder_padding_mask"]) > 0:                 # encoder_out["encoder_padding_mask"]
        src_masks = encoder_out.encoder_padding_mask  # B x T       # encoder_out["encoder_padding_mask"][0]
        # else:
        #     src_masks = None
...
class NATransformerEncoder(FairseqNATEncoder):
    ...
    def forward(
        ...
        # return {
        #     "encoder_out": [x],  # T x B x C fairseq0.10.2中没有[]
        #     "encoder_padding_mask": [encoder_padding_mask],  # B x T  fairseq0.10.2中没有[]
        #     "encoder_embedding": [encoder_embedding],  # B x T x C   fairseq0.10.2中没有[]
        #     "encoder_pos": [encoder_pos],   # fairseq0.10.2中没有返回这个
        #     "length_out": [len_x],   # fairseq0.10.2中没有返回这个
        #     "encoder_states": encoder_states,  # List[T x B x C] # 跟fairseq0.10.2中一样
        #     "src_tokens": [],
        #     "src_lengths": [],
        # }
