...
def main(log_path,match_s1,match_s2,match_s3,num,num_update):
    ...
    print("checkpoint%s.pt checkpoint%s.pt checkpoint%s.pt checkpoint%s.pt checkpoint%s.pt"\
            %(sort_bleu[20]["epoch"].lstrip("0"),sort_bleu[21]["epoch"].lstrip("0"),sort_bleu[22]["epoch"].lstrip("0"),sort_bleu[23]["epoch"].lstrip("0"),sort_bleu[24]["epoch"].lstrip("0")))
    print("21-25: ","—"*46)
    print("checkpoint%s.pt checkpoint%s.pt checkpoint%s.pt checkpoint%s.pt checkpoint%s.pt"\
            %(sort_bleu[25]["epoch"].lstrip("0"),sort_bleu[26]["epoch"].lstrip("0"),sort_bleu[27]["epoch"].lstrip("0"),sort_bleu[28]["epoch"].lstrip("0"),sort_bleu[29]["epoch"].lstrip("0")))
    print("26—30: ","—"*46)
    print("checkpoint%s.pt checkpoint%s.pt checkpoint%s.pt checkpoint%s.pt checkpoint%s.pt"\
            %(sort_bleu[30]["epoch"].lstrip("0"),sort_bleu[31]["epoch"].lstrip("0"),sort_bleu[32]["epoch"].lstrip("0"),sort_bleu[33]["epoch"].lstrip("0"),sort_bleu[34]["epoch"].lstrip("0")))
    print("31—35: ","—"*46)
    print("checkpoint%s.pt checkpoint%s.pt checkpoint%s.pt checkpoint%s.pt checkpoint%s.pt"\
            %(sort_bleu[35]["epoch"].lstrip("0"),sort_bleu[36]["epoch"].lstrip("0"),sort_bleu[37]["epoch"].lstrip("0"),sort_bleu[38]["epoch"].lstrip("0"),sort_bleu[39]["epoch"].lstrip("0")))
    print("36—40: ","—"*46)
