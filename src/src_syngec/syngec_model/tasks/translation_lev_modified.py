...
'''
所有修改
1. dataclass=TranslationLevenshteinConfig注释掉了
2. self.cfg改为了self.args
3. 添加的用户参数的位置改了
4. cfg: TranslationLevenshteinConfig注释掉了
5. import TranslationConfig注释掉了
'''
#######################改↓###############################
# @dataclass
# class TranslationLevenshteinConfig(TranslationConfig):  # 多
...
@register_task("translation_lev_modified")  # 改 , dataclass=TranslationLevenshteinConfig
...
#######################改↑###############################
    def load_dataset(self, split, epoch=1, combine=False, **kwargs):
        ...
        self.datasets[split] = load_langpair_dataset(  # 这里一样
            data_path,
            split,
            src,
            self.src_dict,
    ...
    def build_generator(self, models, args, **unused):
        # add models input to match the API for SequenceGenerator GlatLabelSmoothedDualImitationCriterion
