...
def load_langpair_dataset(
    ...
    if load_syntax:  # True
        ...
        for conll_suffix in args.conll_suffix:  # args.conll_suffix:['conll']
            src_conll_path = os.path.join(data_path, "{}.{}.{}-{}.{}".format(split, conll_suffix.strip(), src,
                                                                             tgt, src))  # '/opt/data/private/friends/tzc/SynGEC-main/data/preprocess/english_clang8_with_syntax_transformer/bin/valid.conll.src-tgt.src'
...
@register_task("syntax-enhanced-dslp-ctc-mt")
class DSLPCTCSyntaxEnhancedNATTask(TranslationTask):
    """
