...
@register_model("syntax_nonautoregressive_transformer")
class SyntaxNATransformerModel(SyntaxFairseqNATModel):
    @property
...
@register_model_architecture(
    "syntax_nonautoregressive_transformer", "syntax_nonautoregressive_transformer"
)
...
@register_model_architecture(
    "syntax_nonautoregressive_transformer", "syntax_nonautoregressive_transformer_wmt_en_de"
)
def syntax_nonautoregressive_transformer_wmt_en_de(args):
