...
from .dslp_shared import NATransformerDecoder, NATransformerEncoder
import random
...
@register_model("glat_dslp")  # nat_sd_glat
class GDNATransformerModel(FairseqNATModel):
