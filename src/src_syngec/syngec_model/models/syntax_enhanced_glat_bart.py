...
# from .syntax_enhanced_nonautogressive_transformer import SyntaxNATransformerModel, syntax_nonautoregressive_transformer
from .syntax_glat import SyntaxGlat, base_architecture
from fairseq.modules.transformer_sentence_encoder import init_bert_params
from ..hub.hub_interface import BARTHubInterface


logger = logging.getLogger(__name__)

'''
1. @register_model("syntax_enhanced_bart")改为@register_model("syntax_enhanced_bart_nat")
2.from .syntax_enhanced_transformer import SyntaxEnhancedTransformerModel, syntax_enhanced_transformer, syntax_enhanced_transformer_big
3.class SyntaxEnhancedBARTModel(SyntaxEnhancedTransformerModel)
改为class SyntaxEnhancedNATBARTModel(SyntaxNATransformerModel):
4.
# from .syntax_enhanced_transformer import SyntaxEnhancedTransformerModel, syntax_enhanced_transformer, syntax_enhanced_transformer_big
# from .syntax_enhanced_nonautogressive_transformer import SyntaxNATransformerModel, syntax_nonautoregressive_transformer
from .syntax_glat_nonautoregressive import SyntaxGlatNATransformerModel, syntax_glat_nonautoregressive_transformer
5.
super(SyntaxEnhancedBARTModel, SyntaxEnhancedBARTModel).add_args(parser)改为：
super(SyntaxEnhancedNATBARTModel, SyntaxEnhancedNATBARTModel).add_args(parser)
6.
syntax_enhanced_transformer(args)
改为
syntax_nonautoregressive_transformer(args)
7.(这个没有修改)
    bart_large_architecture(args)改为：
    syntax_nonautoregressive_transformer(args)
8.
@register_model_architecture("syntax_enhanced_nat_bart", "syntax_enhanced_nat_bart_base")
def nat_bart_base_architecture(args):
9.
@register_model_architecture("syntax_enhanced_nat_bart", "syntax_enhanced_nat_bart_large")
def nat_bart_large_architecture(args):
'''


@register_model("syntax_enhanced_glat_bart")
# class SyntaxEnhancedNATBARTModel(SyntaxNATransformerModel):
class SyntaxEnhancedGlatBARTModel(SyntaxGlat):
    @classmethod
    def hub_models(cls):
        return {
    ...
    @staticmethod
    def add_args(parser):
        super(SyntaxEnhancedGlatBARTModel, SyntaxEnhancedGlatBARTModel).add_args(parser)
        parser.add_argument(
            "--pooler-dropout",
            type=float,
            metavar="D",
...
@register_model_architecture("syntax_enhanced_glat_bart", "syntax_enhanced_glat_bart_large")
def glat_bart_large_architecture(args):
...
@register_model_architecture("syntax_enhanced_glat_bart", "syntax_enhanced_glat_bart_base")
def glat_bart_base_architecture(args):
    ...
    glat_bart_large_architecture(args)
    # syntax_nonautoregressive_transformer(args)
