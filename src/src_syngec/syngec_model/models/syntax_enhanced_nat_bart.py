...
from .syntax_glat_nonautoregressive import SyntaxGlatNATransformerModel, base_architecture
...
@register_model("syntax_enhanced_nat_bart")
# class SyntaxEnhancedNATBARTModel(SyntaxNATransformerModel):
class SyntaxEnhancedNATBARTModel(SyntaxGlatNATransformerModel):
    @classmethod
    def hub_models(cls):
        return {
...
def nat_bart_base_architecture(args):
    ...
    nat_bart_large_architecture(args)
    # syntax_nonautoregressive_transformer(args)
