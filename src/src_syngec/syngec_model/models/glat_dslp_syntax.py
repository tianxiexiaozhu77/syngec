...
from .syntax_enhanced_fairseq_nat_model import SyntaxFairseqNATDecoder, SyntaxFairseqNATModel, ensemble_decoder
...
from .dslp_shared_syn import NATransformerDecoder, NATransformerEncoder
...
1.  def forward(
    ...
    def forward(
            ...
            glat=None, **kwargs
2. 
@register_model("glat_dslp_syntax")  # nat_sd_glat
class GDSNATransformerModel(FairseqNATModel):
3.
@register_model_architecture(
    "glat_dslp_syntax", "glat_dslp_syntax_base"
)
4.
from .syntax_glat_nonautoregressive import SyntaxGlatNATransformerEncoder

6.    def build_encoder(cls, args, tgt_dict, embed_tokens):
        encoder = SyntaxGlatNATransformerEncoder(args, tgt_dict, embed_tokens)
7.
改
from .syntax_enhanced_fairseq_nat_model import SyntaxFairseqNATDecoder, SyntaxFairseqNATModel, ensemble_decoder
和
class GDSNATransformerModel(SyntaxFairseqNATModel):
...
@register_model_architecture(
    "glat_dslp_syntax", "glat_dslp_syntax"
)
def base_architecture(args):
    args.encoder_embed_path = getattr(args, "encoder_embed_path", None)
    args.encoder_embed_dim = getattr(args, "encoder_embed_dim", 512)
...
@register_model_architecture(
    "glat_dslp_syntax", "glat_dslp_syntax_12d"
)
...
@register_model_architecture(
    "glat_dslp_syntax", "glat_dslp_syntax_24d"
)
...
@register_model_architecture(
    "glat_dslp_syntax", "glat_dslp_syntax_12e"
)
