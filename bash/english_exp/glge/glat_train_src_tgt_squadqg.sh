...
export CUDA_VISIBLE_DEVICES=3  # 只有一个可见
touch /opt/data/private/zjx/syngec/bash/english_exp/glge/log/$(date -d "today" +"%Y.%m.%d_glat_squadqg_stc_tgt_1").log
save_path="/opt/data/private/zjx/ckpt/glge/squadqg/1"
# data_dir="/opt/data/private/friends/tzc/data/iwslt_de/iwslt_de/bin"  # raw data
data_dir="/opt/data/private/zjx/data/glge_processed/squadqg_easy/bin"  # distill data
...
nohup fairseq-train  \
    ...
    > /opt/data/private/zjx/syngec/bash/english_exp/glge/log/$(date -d "today" +"%Y.%m.%d_glat_squadqg_stc_tgt_1").log 2>&1 &
