...
touch /opt/data/private/zjx/syngec/bash/english_exp/glge/log/$(date -d "today" +"%Y.%m.%d_glat_persona_src_tgt_1").log
save_path="/opt/data/private/zjx/ckpt/glge/persona/1"
# data_dir="/opt/data/private/friends/tzc/data/iwslt_de/iwslt_de/bin"  # raw data
data_dir="/opt/data/private/zjx/data/glge_processed/personachat_easy/bin"  # distill data
...
nohup fairseq-train  \
    ...
    > /opt/data/private/zjx/syngec/bash/english_exp/glge/log/$(date -d "today" +"%Y.%m.%d_glat_persona_src_tgt_1").log 2>&1 &
