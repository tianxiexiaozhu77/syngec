...
checkpoint_path=/opt/data/private/friends/tzc/checkpoint/checkpoint_syntax_glat_ctc/7/checkpoint_ave.pt
src=de
tgt=en
CUDA_VISIBLE_DEVICES=0 python /opt/data/private/zjx/SynGEC-main/src/src_syngec/fairseq-0.10.2/fairseq_cli/generate.py > glat_ctc_syntax_deen.log \
...
bash /opt/data/private/zjx/SynGEC-main/src/src_syngec/fairseq-0.10.2/scripts/compound_split_bleu.sh glat_ctc_syntax_deen.log
