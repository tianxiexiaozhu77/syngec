...
checkpoint_path=/opt/data/private/friends/tzc/checkpoint/checkpoint_syntax_glat_ctc/8/checkpoint_ave.pt
src=en
tgt=ro
CUDA_VISIBLE_DEVICES=0 python /opt/data/private/zjx/SynGEC-main/src/src_syngec/fairseq-0.10.2/fairseq_cli/generate.py > glat_ctc_syntax_enro.log \
...
bash /opt/data/private/zjx/SynGEC-main/src/src_syngec/fairseq-0.10.2/scripts/compound_split_bleu.sh glat_ctc_syntax_enro.log
