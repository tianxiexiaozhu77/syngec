...
checkpoint_path=/opt/data/private/friends/tzc/checkpoint/checkpoint_syntax_glat/wmt/ende/nat64/checkpoint_ave.pt
src=en
tgt=de
...
# bash /opt/data/private/friends/tzc/SynGEC-main/src/src_syngec/fairseq-0.10.2/scripts/compound_split_bleu.sh res64.log
