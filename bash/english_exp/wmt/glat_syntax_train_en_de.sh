...
touch /opt/data/private/friends/tzc/SynGEC-main/src/src_syngec/syngec_model/$(date -d "today" +"%Y.%m.%d_syntax_glat_en_de_17_19_24").log
nohup fairseq-train  \
    /opt/data/private/friends/tzc/data/wmt_gp/process.disco/wmt16.en-de/deal/all/bin \
    -s en \
    -t de \
    --save-dir /opt/data/private/friends/tzc/checkpoint/checkpoints_syntax_nat/nat64 \
    ...
    --seed 0 \
    > /opt/data/private/friends/tzc/SynGEC-main/src/src_syngec/syngec_model/$(date -d "today" +"%Y.%m.%d_syntax_glat_en_de_17_19_24").log 2>&1 &
