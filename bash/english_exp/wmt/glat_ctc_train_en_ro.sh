...
save_path="/opt/data/private/friends/tzc/checkpoint/checkpoint_glat_ctc/7"
data_dir="/opt/data/private/zjx/data/wmt/enro/bin"
user_dir="/opt/data/private/zjx/SynGEC-main/src/src_syngec/syngec_model"
touch /opt/data/private/zjx/SynGEC-main/src/src_syngec/syngec_model/log/$(date -d "today" +"%Y.%m.%d_glat_ctc_wmt_en_ro_1").log
nohup fairseq-train \
    -s en \
    -t ro \
    ...
    --max-source-positions 1024 --max-target-positions 1024 --max-update 400000 --seed 0 --clip-norm 2 \
    ...
    > /opt/data/private/zjx/SynGEC-main/src/src_syngec/syngec_model/log/$(date -d "today" +"%Y.%m.%d_glat_ctc_wmt_en_ro_1").log 2>&1 &
