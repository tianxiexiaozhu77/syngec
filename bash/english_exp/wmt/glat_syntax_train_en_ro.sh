...
touch /opt/data/private/zjx/SynGEC-main/src/src_syngec/syngec_model/$(date -d "today" +"%Y.%m.%d_syntax_glat_en_ro_1").log
nohup fairseq-train  \
    /opt/data/private/zjx/data/wmt/enro/bin \
    -s en \
    -t ro \
    --save-dir /opt/data/private/friends/tzc/checkpoint/checkpoint_syntax_glat/wmt/enro/4 \
    ...
    --no-scale-embedding \
    --seed 0 \
    > /opt/data/private/zjx/SynGEC-main/src/src_syngec/syngec_model/$(date -d "today" +"%Y.%m.%d_syntax_glat_en_ro_1").log 2>&1 &
