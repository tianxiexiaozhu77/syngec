...
save_path=/opt/data/private/friends/tzc/checkpoint/checkpoints_syntax_nat/nat49
data_dir=/opt/data/private/friends/tzc/data/wmt_gp/process.disco/wmt16.en-de/deal/all/bin  # disco data
user_dir=/opt/data/private/friends/tzc/SynGEC-main/src/src_syngec/syngec_model
touch /opt/data/private/friends/tzc/SynGEC-main/src/src_syngec/syngec_model/$(date -d "today" +"%Y.%m.%d_syntax_nat_en_de_log_1").log
nohup fairseq-train  \
    ${data_dir} \
    -s en \
    -t de \
    ...
    --seed 0 \
    > /opt/data/private/friends/tzc/SynGEC-main/src/src_syngec/syngec_model/$(date -d "today" +"%Y.%m.%d_syntax_nat_en_de_log_1").log 2>&1 &
