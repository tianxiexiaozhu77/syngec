...
save_path="/opt/data/private/friends/tzc/checkpoint/checkpoint_syntax_glat_ctc/9"
data_dir="/opt/data/private/zjx/data/wmt/roen/bin"
user_dir="/opt/data/private/zjx/SynGEC-main/src/src_syngec/syngec_model"
touch /opt/data/private/zjx/SynGEC-main/src/src_syngec/syngec_model/log/$(date -d "today" +"%Y.%m.%d_syntax_glat_ctc_wmt_ro_en_1").log
nohup fairseq-train \
    ...
    --syntax-encoder GCN \
    --ddp-backend=no_c10d \
    > /opt/data/private/zjx/SynGEC-main/src/src_syngec/syngec_model/log/$(date -d "today" +"%Y.%m.%d_syntax_glat_ctc_wmt_ro_en_1").log 2>&1 &
